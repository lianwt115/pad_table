...
import com.ctd.choose.view.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.bg_line1));
		// 设置线宽
		paint.setStrokeWidth((float) 3);
		// 绘制上边直线
		canvas.drawLine(getWidth()/4, center - offset, 3*getWidth()/4, center - offset, paint);
		// 绘制下边直线
		canvas.drawLine(getWidth()/4, center + offset, 3*getWidth()/4, center + offset, paint);
		//*/
	}
