...
import com.ctd.cymanage.bean.DownloadFileDb
import com.ctd.cymanage.dao.DownloadFileDbUtils
...
class DownloadManager {
    ...
    companion object {
        ...
        private var FILE_PATH = Environment.getExternalStorageDirectory().absolutePath+"/cymanage/download/"
    ...
    constructor(listener: DownloadListen, id: String, type:Int,fileName: String){
     ...
     * @param subscriber
     */
    private fun download(id: String, type: Int,fileName:String) {
        ...
        retrofit.create(ApiService::class.java).download(id)?.map(DownloadResultFunc()).doOnNext {
            ...
            DownloadFileDbUtils.insertOrReplace(DownloadFileDb(null,fileName,id,System.currentTimeMillis(),type,filePath))
