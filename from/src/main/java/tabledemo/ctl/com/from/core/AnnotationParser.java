...
import tabledemo.ctl.com.from.annotation.ColumnType;
import tabledemo.ctl.com.from.annotation.SmartColumn;
import tabledemo.ctl.com.from.data.column.ArrayColumn;
import tabledemo.ctl.com.from.data.column.Column;
import tabledemo.ctl.com.from.data.table.PageTableData;
import tabledemo.ctl.com.from.exception.TableException;
    ...
    public PageTableData<T> parse(List<T> dataList){
        if(dataList!= null && dataList.size() >0) {
            ...
            if(firstData != null) {
                ...
                Annotation tableAnnotation = clazz.getAnnotation(tabledemo.ctl.com.from.annotation.SmartTable.class);
                if(tableAnnotation != null){
                    tabledemo.ctl.com.from.annotation.SmartTable table = (tabledemo.ctl.com.from.annotation.SmartTable) tableAnnotation;
