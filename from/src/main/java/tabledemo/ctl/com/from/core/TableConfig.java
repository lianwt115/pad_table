...
import tabledemo.ctl.com.from.data.format.draw.LeftTopDrawFormat;
import tabledemo.ctl.com.from.data.format.grid.IGridFormat;
import tabledemo.ctl.com.from.data.format.grid.SimpleGridFormat;
import tabledemo.ctl.com.from.data.style.FontStyle;
import tabledemo.ctl.com.from.data.style.LineStyle;
...
public class TableConfig {
     ...
     * 默认网格样式
     */
    private LineStyle defaultGridStyle = new LineStyle(2f, Color.parseColor("#000000"));
    /**
     * 无效值
     */
     ...
     * 是否显示表格标题
     */
    private boolean isShowTableTitle = false;
    /**
     * 是否显示列标题
     */
    ...
    public void setLineStyle(float lineWidth,int lineColor){
        defaultGridStyle.setDefaultLineSize(lineWidth);
        defaultGridStyle.setDefaultLineColor(lineColor);
