package tabledemo.ctl.com.from.data.table;
...
import tabledemo.ctl.com.from.data.Cell;
import tabledemo.ctl.com.from.data.CellRange;
import tabledemo.ctl.com.from.data.TableInfo;
import tabledemo.ctl.com.from.data.column.Column;
import tabledemo.ctl.com.from.data.column.ColumnInfo;
import tabledemo.ctl.com.from.data.format.sequence.ISequenceFormat;
import tabledemo.ctl.com.from.data.format.sequence.LetterSequenceFormat;
import tabledemo.ctl.com.from.data.format.sequence.NumberSequenceFormat;
import tabledemo.ctl.com.from.data.format.title.ITitleDrawFormat;
import tabledemo.ctl.com.from.data.format.title.TitleDrawFormat;
...
public class TableData<T> {
    ...
    private boolean showCount = false; //显示统计,默认不显示
